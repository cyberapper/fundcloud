...
| 21 | [Cost, slippage, execution lab](./21_cost_model_lab.py) | `NoCost` / `FixedBps` / `PerShare`, `NoSlippage` / `HalfSpread`, `NextBarOpen` / `NextBarClose` — same DCA, six friction configs | core |
